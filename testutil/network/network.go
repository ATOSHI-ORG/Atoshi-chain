...
import (
	...
	"github.com/atoshi-chain/atoshi/v20/crypto/hd"
...
func DefaultConfig() Config {
	...
	app := app.NewAtoshi(log.NewNopLogger(), dbm.NewMemDB(), nil, true, nil, dir, 0, simutils.NewAppOptionsWithFlagHome(dir), app.AtoshiAppOptions, baseapp.SetChainID(chainID))
	return Config{
		Codec:             app.AppCodec(),
