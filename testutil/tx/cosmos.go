...
var (
	...
	DefaultFee = sdk.NewCoin(evmostypes.BaseDenom, sdkmath.NewIntFromUint64(uint64(feeAmt))) // 0.01 ATOS
)
...
type CosmosTxArgs struct {
	...
	// ChainID is the chain's id on cosmos format, e.g. 'atoshi_88388-1'
	ChainID string
