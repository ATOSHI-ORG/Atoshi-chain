...
type genSetupFn func(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *app.Atoshi, genesisState evmostypes.GenesisState, _ interface{}) (evmostypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
...
func createEvmosApp(chainID string, customBaseAppOptions ...func(*baseapp.BaseApp)) *app.Atoshi {
	// Create evmos app
	db := dbm.NewMemDB()
...
func setDefaultStakingGenesisState(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, overwriteParams StakingCustomGenesisState) evmostypes.GenesisState {
	// Set staking params
...
func setDefaultBankGenesisState(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, overwriteParams BankCustomGenesisState) evmostypes.GenesisState {
...
func setDefaultSlashingGenesisState(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, overwriteParams SlashingCustomGenesisState) evmostypes.GenesisState {
...
func setBankGenesisState(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
...
func setDefaultAuthGenesisState(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, genAccs []authtypes.GenesisAccount) evmostypes.GenesisState {
...
func setAuthGenesisState(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, customGenesis interface{}) (evmostypes.GenesisState, error) {
...
func setDefaultGovGenesisState(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, overwriteParams GovCustomGenesisState) evmostypes.GenesisState {
...
func setDefaultFeeMarketGenesisState(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState, overwriteParams FeeMarketCustomGenesisState) evmostypes.GenesisState {
...
func setDefaultErc20GenesisState(evmosApp *app.Atoshi, genesisState evmostypes.GenesisState) evmostypes.GenesisState {
...
func newDefaultGenesisState(evmosApp *app.Atoshi, params defaultGenesisParams) evmostypes.GenesisState {
...
func customizeGenesis(evmosApp *app.Atoshi, customGen CustomGenesisState, genesisState evmostypes.GenesisState) (evmostypes.GenesisState, error) {
	var err error
