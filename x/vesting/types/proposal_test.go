...
func (suite *ProposalTestSuite) TestClawbackProposal() {
	testCases := []struct {
		...
		// Valid tests
		{
			...
			address:     "atoshi19y7d5jz7q0v86zw5m0300mhprpvu0cccthnxy0",
			expectPass:  true,
		},
		...
		// Invalid address
		{
			msg:         "Clawback proposal - invalid address (bad checksum)",
			title:       "test",
			description: "test desc",
			address:     "atoshi19y7d5jz7q0v86zw5m0300mhprpvu0cccthnxyq",
			expectPass:  false,
		},
		{
