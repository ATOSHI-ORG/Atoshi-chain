...
import (
	...
	"github.com/atoshi-chain/atoshi/v20/x/epochs/client/cli"
	"github.com/atoshi-chain/atoshi/v20/x/epochs/keeper"
	"github.com/atoshi-chain/atoshi/v20/x/epochs/types"
)
...
// GetQueryCmd returns the root query command for the epochs module.
