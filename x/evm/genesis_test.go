...
func TestExportGenesis(t *testing.T) {
	...
	require.Len(t, genState.Accounts, 3, "expected 3 smart contracts in the exported genesis") // NOTE: 2 deployed above + 1 for the liao denomination ERC-20 pair
	...
	require.Contains(t, genAddresses, erc20.WEVMOSContractMainnet, "expected mainnet liao contract address in exported genesis")
}
