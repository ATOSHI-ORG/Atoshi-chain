...
import (
	...
	testnetwork "github.com/atoshi-chain/atoshi/v20/testutil/integration/evmos/network"
	erc20 "github.com/atoshi-chain/atoshi/v20/x/erc20/types"
...
func TestExportGenesis(t *testing.T) {
	...
	require.Len(t, genState.Accounts, 3, "expected 3 smart contracts in the exported genesis") // NOTE: 2 deployed above + 1 for the aatos denomination ERC-20 pair
	...
	require.Contains(t, genAddresses, erc20.WEVMOSContractMainnet, "expected mainnet aatos contract address in exported genesis")
}
