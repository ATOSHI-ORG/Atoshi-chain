...
import (
	...
	_ "github.com/atoshi-chain/atoshi/v20/server/config/migration" // Add this import to set up the proper app.toml migration logic for sdk v0.50
)
...
const (
	...
	DefaultRosettaDenomToSuggest = "aatos"
