...
import (
	...
	atoshiclient "github.com/atoshi-chain/atoshi/v20/client"
	"github.com/atoshi-chain/atoshi/v20/client/block"
	"github.com/atoshi-chain/atoshi/v20/client/debug"
	atoshiserver "github.com/atoshi-chain/atoshi/v20/server"
	servercfg "github.com/atoshi-chain/atoshi/v20/server/config"
	srvflags "github.com/atoshi-chain/atoshi/v20/server/flags"

	"github.com/atoshi-chain/atoshi/v20/app"
	atoshikr "github.com/atoshi-chain/atoshi/v20/crypto/keyring"
)

const EnvPrefix = "ATOSHI"

type emptyAppOptions struct{}

func (ao emptyAppOptions) Get(_ string) interface{} { return nil }

// NewRootCmd creates a new root command for atoshid. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, sdktestutil.TestEncodingConfig) {
	// we "pre"-instantiate the application for getting the injected/configured encoding configuration
	// and the CLI options for the modules
	// add keyring to autocli opts
	tempApp := app.NewAtoshi(
		log.NewNopLogger(),
		dbm.NewMemDB(),
		nil, true, nil,
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(atoshikr.Option()).
		WithViper(EnvPrefix).
	...
	atoshiserver.AddCommands(
		rootCmd,
		atoshiserver.NewDefaultStartOptions(a.newApp, app.DefaultNodeHome),
		a.appExport,
		addModuleInitFlags,
	)
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		atoshiclient.KeyCommands(app.DefaultNodeHome),
	)
...
func initAppConfig() (string, interface{}) {
	...
	if err != nil {
		...
		baseDenom = atoshitypes.BaseDenom
	}
...
func (a appCreator) appExport(
	...
	if height != -1 {
		atoshiApp = app.NewAtoshi(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), appOpts, app.AtoshiAppOptions)

		if err := atoshiApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		atoshiApp = app.NewAtoshi(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), appOpts, app.AtoshiAppOptions)
	}

	return atoshiApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}
