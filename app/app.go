...
import (
	...
	_ "github.com/atoshi-chain/atoshi/v20/client/docs/statik"
	"github.com/atoshi-chain/atoshi/v20/utils"

	atoshitypes "github.com/atoshi-chain/atoshi/v20/types"
	"github.com/atoshi-chain/atoshi/v20/x/epochs"
	epochskeeper "github.com/atoshi-chain/atoshi/v20/x/epochs/keeper"
	epochstypes "github.com/atoshi-chain/atoshi/v20/x/epochs/types"
	"github.com/atoshi-chain/atoshi/v20/x/evm"
	evmkeeper "github.com/atoshi-chain/atoshi/v20/x/evm/keeper"
	evmtypes "github.com/atoshi-chain/atoshi/v20/x/evm/types"
	inflation "github.com/atoshi-chain/atoshi/v20/x/inflation/v1"
	...
	"github.com/atoshi-chain/atoshi/v20/app/ante"
	...
	"github.com/atoshi-chain/atoshi/v20/x/ibc/transfer"
	transferkeeper "github.com/atoshi-chain/atoshi/v20/x/ibc/transfer/keeper"

	memiavlstore "github.com/crypto-org-chain/cronos/store"

	// Force-load the tracer engines to trigger registration due to Go-Ethereum v1.10.15 changes
	_ "github.com/atoshi-chain/atoshi/v20/x/evm/core/tracers/js"
	_ "github.com/atoshi-chain/atoshi/v20/x/evm/core/tracers/native"
)

func init() {
	var err error
	DefaultNodeHome, err = clienthelpers.GetNodeHomeDirectory(".atoshid")
	if err != nil {
		panic(err)
	}

	// manually update the power reduction by replacing micro (u) -> atto (a) atoshi
	sdk.DefaultPowerReduction = atoshitypes.PowerReduction
...
var (
	_ servertypes.Application = (*Atoshi)(nil)
	_ ibctesting.TestingApp   = (*Atoshi)(nil)
	_ runtime.AppI            = (*Atoshi)(nil)
)
...
func (*Atoshi) SimulationManager() *module.SimulationManager {
	panic("unimplemented")
}

// NewAtoshi returns a reference to a new initialized Ethermint application.
func NewAtoshi(
	logger log.Logger,
	db dbm.DB,
	...
	atoshiAppOptions AtoshiOptionsFn,
	...
	if err := atoshiAppOptions(bApp.ChainID()); err != nil {
		panic(err)
	}
...
func (app *Atoshi) Name() string { return app.BaseApp.Name() }

func (app *Atoshi) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: atoshitypes.HasDynamicFeeExtensionOption,
...
func (app *Atoshi) setPostHandler() {
...
func (app *Atoshi) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.mm.BeginBlock(ctx)
}

// EndBlocker updates every end block
func (app *Atoshi) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
...
func (app *Atoshi) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
	var genesisState atoshitypes.GenesisState
...
func (app *Atoshi) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.mm.PreBlock(ctx)
}

// LoadHeight loads state at a particular height
func (app *Atoshi) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Atoshi) ModuleAccountAddrs() map[string]bool {
...
func (app *Atoshi) BlockedAddrs() map[string]bool {
...
func (app *Atoshi) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Atoshi) AppCodec() codec.Codec {
	return app.appCodec
}
...
func (app *Atoshi) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Atoshi) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Atoshi) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Atoshi) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Atoshi) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Atoshi) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Atoshi) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Atoshi) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Atoshi) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *Atoshi) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Atoshi) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Atoshi) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Atoshi) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Atoshi) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Atoshi) GetTxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *Atoshi) AutoCliOpts() autocli.AppOptions {
...
func (app *Atoshi) setupUpgradeHandlers() {
	// v20 upgrade handler
