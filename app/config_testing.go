...
// AtoshiOptionsFn defines a function type for setting app options specifically for
// the Atoshi app. The function should receive the chainID and return an error if
// any.
type AtoshiOptionsFn func(string) error

// NoOpAtoshiOptions is a no-op function that can be used when the app does not
// need any specific configuration.
func NoOpAtoshiOptions(_ string) error {
	return nil
}

// AtoshiAppOptions allows to setup the global configuration
// for the Atoshi chain.
func AtoshiAppOptions(chainID string) error {
	...
	err = configurator.
		WithExtendedEips(atoshiActivators).
