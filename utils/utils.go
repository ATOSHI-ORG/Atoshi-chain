...
const (
	// MainnetChainID defines the Atoshi EIP155 chain ID for mainnet
	MainnetChainID = "atoshi_88188"
	// TestnetChainID defines the Atoshi EIP155 chain ID for testnet
	TestnetChainID = "atoshi_88288"
	// TestingChainID defines the Atoshi EIP155 chain ID for testing/development purposes
	// like the local node.
	TestingChainID = "atoshi_88388"
	// SixDecChainID defines the Atoshi EIP155 chain ID with 6 decimals precision
	SixDecChainID = "atoshiix_88388"
	// ICSChainID defines the Atoshi EIP155 chain ID with IBC uatom as denom with 6 decimals precision
	ICSChainID = "atoshiics_88388"
)
...
// IsMainnet returns true if the chain-id has the Atoshi mainnet EIP155 chain prefix.
func IsMainnet(chainID string) bool {
	return strings.HasPrefix(chainID, MainnetChainID)
}

// IsTestnet returns true if the chain-id has the Atoshi testnet EIP155 chain prefix.
