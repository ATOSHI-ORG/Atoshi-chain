...
import (
	...
	evmosapp "github.com/atoshi-chain/atoshi/v20/app"
...
func Call(ctx sdk.Context, app *evmosapp.Atoshi, args CallArgs) (res abci.ExecTxResult, ethRes *evmtypes.MsgEthereumTxResponse, err error) {
	var (
		nonce    uint64
...
func CallContractAndCheckLogs(ctx sdk.Context, app *evmosapp.Atoshi, cArgs CallArgs, logCheckArgs testutil.LogCheckArgs) (abci.ExecTxResult, *evmtypes.MsgEthereumTxResponse, error) {
