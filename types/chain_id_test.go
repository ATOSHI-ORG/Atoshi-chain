...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "atoshi_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "ATOSHI_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Atoshi_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "atoshi_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "atoshi_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "atoshi_atoshi_88388-1", true, nil,
		},
		{
			"invalid epoch, undefined", "atoshi_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "atoshi_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
